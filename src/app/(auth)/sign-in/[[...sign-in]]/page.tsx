...
export default function SignInPage() {
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-6">
      ...
      {showAdminBypass ? (
        <form onSubmit={handleAdminDirectLogin} className="bg-surface border border-border p-8 rounded-2xl space-y-6 shadow-2xl">
          <div className="text-center space-y-1">
            ...
            <h2 className="font-serif text-2xl text-foreground font-medium">Executive Admin Portal</h2>
            <p className="text-xs text-foreground-muted font-light">Instant direct sign-in for <span className="text-[#C9A96E] font-medium">piyella@gmail.com</span></p>
          </div>
